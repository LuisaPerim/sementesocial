document.querySelector('form').addEventListener('submit', async (event) => {
    ...
    formData.append('cnpj', document.querySelector('input[name="cnpj"]').value);
    formData.append('nome_responsavel', document.querySelector('input[name="resp"]').value);
    ...
    formData.append('categoria', document.querySelector('select[name="cat"]').value);
    ...
    try {
        ...
        const response = await fetch('http://localhost:2000/api/cadastrar/ong', {
            method: 'POST',
